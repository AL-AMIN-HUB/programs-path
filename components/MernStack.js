  ...
  return (
    <section className="cloudOps_section">
      <div className="main_container">
        {/* 1st step  */}
        <div className="container learningPath_main">
          ...
          <div className="col_learning2">
            ...
            <div>
              <div className="img_main">
                <img style={{ width: "100%" }} src="https://i.ibb.co/qx0Jrqr/1.png" alt="" />
              </div>
            </div>
          </div>
          <div className="col_learning3">
            ...
            <div>
              <div className="img_main2">
                <img src="https://i.ibb.co/HPHYqvK/2.png" alt="" />
              </div>
      ...
      {/* step 2 */}
      <div id="step2" className="container second_path_learning">
        <div className="col_learning1">
          <h3>2 STEP</h3>
          <h2>BEGINNERS</h2>
        ...
        <div className="col_learning5">
          <div>
            <img className="img_path2" src="https://i.ibb.co/WgXJSdt/4.png" alt="" />
          </div>
          <div>
        ...
        <div className="col_learning6">
          <div>
            <img style={{ width: "100%" }} className="img_path2" src="https://i.ibb.co/GVgS46Y/3.png" alt="" />
          </div>
          <div>
            <div className="item_path">
              <p>Course</p>
      ...
      {/* step 3 */}
      <div className="container third_path_learning">
        <div></div>
        <div>
          {" "}
          <div className="col_learning7">
            <div>
              <img style={{ width: "100%" }} className="img_path7" src="https://i.ibb.co/sw26bDk/12.png" alt="" />
            </div>
            <div>
              <div className="item_path">
                <p>Course</p>
        ...
        <div>
          ...
          <div className="col_learning8">
            <div>
              <img style={{ width: "100%" }} className="img_path8" src="https://i.ibb.co/S768Nq1/5.png" alt="" />
            </div>
            <div>
              <div className="item_path">
                <p>Course</p>
      ...
      {/* step 4 */}
      <div className="container fourth_path_learning">
        <div>
          {" "}
          <div className="col_learning10">
            <div>
              <img style={{ width: "100%" }} className="img_path7" src="https://i.ibb.co/VmjpmVB/14.png" alt="" />
            </div>
            <div>
              <div className="item_path">
                <p>Course</p>
        ...
        <div>
          ...
          <div className="col_learning12">
            <div>
              <img style={{ width: "100%" }} className="img_path7" src="https://i.ibb.co/crv31dF/10.png" alt="" />
            </div>
            <div>
              <div className="item_path">
                <p>Course</p>
        ...
        <div>
          ...
          <div className="col_learning13">
            <div>
              <img style={{ width: "100%" }} className="img_path7" src="https://i.ibb.co/WpqY1rL/11.png" alt="" />
            </div>
            <div>
              <div className="item_path">
                <p>Course</p>
      ...
      <div className="fifth_bg">
        <div className="container fifth_path_learning">
          <div>
        ...
        <div className="container six_path_learning">
          <div>
            {" "}
            <div>
              {" "}
              <div className="col_learning16">
                ...
                <div>
                  <div className="item_path">
                    <p>Course</p>
                    <h4>KUBERNETES - SWARM SERVICES STACK</h4>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div>
            ...
            <div>
              ...
              <div className="col_learning17">
                <div>
                  <img style={{ width: "100%" }} className="img_path7" src="https://i.ibb.co/jgPcjGd/Kubernetes-Prometheus-and-Grafana.png" alt="" />
                </div>
                <div>
                  <div className="item_path">
                    <p>Course</p>
          ...
          <div>
            ...
            <div>
              ...
              <div className="col_learning18">
                <div>
                  <img style={{ width: "100%" }} className="img_path7" src="https://i.ibb.co/6nwJbNy/Internet-Gateway.png" alt="" />
                </div>
                <div>
                  <div className="item_path">
                    <p>Course</p>
          ...
          <div>
            ...
            <div>
              ...
              <div className="col_learning19">
                <div>
                  <img style={{ width: "100%" }} className="img_path7" src="https://i.ibb.co/FsLSXg7/EKSCTL.png" alt="" />
                </div>
                <div>
                  <div className="item_path">
                    <p>Course</p>
        ...
        {/* job support start */}
        <div style={{ marginTop: "100px" }} className="container six_path_learning">
          <div>
            {" "}
            <div>
              {" "}
          ...
          <div>
            ...
            <div>
              ...
              <div className="col_learning21">
                <div>
                  <img style={{ width: "100%" }} className="img_path7" src="https://i.ibb.co/SvWyGxf/8.png" alt="" />
                </div>
                <div>
                  <div className="item_path">
                    <p>Course</p>
          ...
          <div>
            ...
            <div>
              ...
              <div className="col_learning22">
                <div>
                  <img style={{ width: "100%" }} className="img_path7" src="https://i.ibb.co/3BT5YPG/IP.png" alt="" />
                </div>
                <div>
                  <div className="item_path">
                    <p>Course</p>
          ...
          <div>
            ...
            <div>
              ...
              <div className="col_learning23">
                <div>
                  <img style={{ width: "100%" }} className="img_path7" src="https://i.ibb.co/bgLvXLC/Jenkins.png" alt="" />
                </div>
                <div>
                  <div className="item_path">
                    <p>Course</p>
        ...
        <div className="container last_path_learning">
          <div>
          ...
          <div>
            ...
            <div>
              {" "}
              <div className="col_learning24">
                <div>
                  <img style={{ width: "100%" }} className="img_path7" src="https://i.ibb.co/QjWcqLj/9.png" alt="" />
                </div>
                <div>
                  <div className="item_path">
                    <p>Course</p>
      ...
      <div className="stand_section container">
        <div>
          <h2> STAND OUT!</h2>
          <p>
